...
- ticktick_agent: For TickTick task management like creating, updating, completing, deleting tasks, and viewing projects
...
4. For task management (TickTick), delegate to the ticktick_agent with a clear description of what needs to be done
5. You may call multiple subagents in a single turn if the user's request spans multiple domains
6. After receiving subagent results, synthesize them into a clear, helpful response for the user
7. If a subagent is not available (user hasn't connected the service), inform the user and suggest they connect it`;
